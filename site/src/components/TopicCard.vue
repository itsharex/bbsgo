<template>
  <div class="topic-card">
    ...
    <div v-if="firstImage" class="mb-3">
      <img :src="firstImage" class="w-full max-h-48 sm:max-h-64 object-cover rounded-lg" loading="lazy">
    </div>
    ...
    <!-- 文字预览 -->
    <p v-if="!firstImage && !hasVideoFlag && !hasPoll" class="text-gray-600 text-xs sm:text-sm mb-3 line-clamp-3">
      {{ plainContent }}
    </p>
  </div>
</template>
